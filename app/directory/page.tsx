...
import MemberCarousel, { DirectoryCarouselMember } from "./MemberCarousel";
        ...
        <main className="min-h-screen bg-white text-slate-950">
                    ...
                    <div className="mt-5 grid gap-6 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-end">
                        <div className="max-w-4xl">
                            ...
                            <h1 className="mt-3 text-4xl font-black leading-[1.05] tracking-[-0.035em] text-slate-950 sm:text-5xl lg:text-6xl">
                                Find and Verify AHPK Professionals
                            </h1>

                            <p className="mt-4 max-w-3xl text-lg font-medium leading-8 text-slate-600 sm:text-xl sm:leading-9">
                                Search the official public
                                directory to confirm active AHPK
                                membership and view verified
            ...
            <section className="bg-white py-8">
                <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
                        ...
                        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
                            <div>
                                <label
                                    ...
                                    className="text-xs font-black uppercase tracking-[0.2em] text-[#C8102E]"
                                >
                                ...
                                <div className="relative mt-3">
                                    ...
                                    <input
                                        ...
                                        className="min-h-13 w-full border border-slate-300 bg-white py-3 pl-12 pr-4 text-sm font-semibold text-slate-900 outline-none transition placeholder:font-medium placeholder:text-slate-400 hover:border-slate-400 focus:border-[#C8102E] focus:ring-2 focus:ring-red-100"
                                    />
                                </div>
                            </div>
                            ...
                            <button
                                type="submit"
                                className="group flex min-h-13 cursor-pointer items-center justify-center gap-3 bg-[#C8102E] px-7 text-sm font-black text-white transition duration-200 hover:-translate-y-0.5 hover:bg-red-800 hover:shadow-lg"
                            >
                    ...
                    {query ? (
                        <div className="mt-4 flex flex-col gap-3 border-y border-slate-300 py-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <Link
                                href="/directory"
                                className="group inline-flex items-center gap-2 text-sm font-black text-[#C8102E] transition hover:text-red-800"
                            >
            ...
            <section className="border-t border-slate-300 bg-slate-50 py-8 sm:py-10">
                <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
                    <div className="flex flex-col gap-4 border-t-4 border-slate-950 pt-4 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-sm font-medium leading-6 text-slate-500">
                                {totalMembers > 0
                                    ? `Showing ${firstResult}–${lastResult} of ${totalMembers} member${totalMembers === 1 ? "" : "s"}. Drag or use the controls to browse.`
                                    : "No matching members were found."}
                            </p>
                        </div>

                        {totalMembers > 0 ? (
                            <div className="inline-flex w-fit items-center gap-2 border border-emerald-300 bg-white px-4 py-2 text-xs font-black text-emerald-700">
                    ...
                    <div className="grid border-t-4 border-[#C8102E] bg-slate-50 lg:grid-cols-[minmax(0,1fr)_300px]">
                        <div className="p-5 sm:p-6">
                            ...
                            <h2 className="mt-2 text-3xl font-black tracking-tight text-slate-950">
                                Directory records support
                                professional verification.
                            </h2>

                            <p className="mt-3 max-w-3xl text-sm font-medium leading-7 text-slate-600 sm:text-base">
                                Only active members who have
                                approved public visibility appear
                                here. Contact the AHPK Secretariat
                                when additional verification is
                                required.
                            </p>
                        </div>

                        <div className="border-t border-slate-300 bg-slate-950 p-5 text-white lg:border-l lg:border-t-0">
                            <p className="text-xs font-black uppercase tracking-[0.18em] text-red-300">
                                Need Further Assistance?
                            </p>

                            <p className="mt-2 text-sm font-medium leading-6 text-slate-300">
                                Contact the Secretariat about
                                membership status or directory
                                records.
                            </p>

                            <Link
                                href="/contact"
                                className="group mt-4 inline-flex min-h-11 w-full items-center justify-center gap-2 bg-[#C8102E] px-5 text-sm font-black text-white transition duration-200 hover:-translate-y-0.5 hover:bg-red-700"
                            >
                                Contact Secretariat
...
function EmptyState({
    ...
    return (
        <div className="mt-6 border-t-4 border-[#C8102E] bg-white p-6 text-center sm:p-10">
            <FileSearch className="mx-auto h-9 w-9 text-[#C8102E]" />
            ...
            <div className="mt-5 flex flex-col justify-center gap-3 sm:flex-row">
                <Link
                    href="/directory"
                    className="group inline-flex min-h-11 items-center justify-center gap-2 bg-[#C8102E] px-6 text-sm font-black text-white transition duration-200 hover:-translate-y-0.5 hover:bg-red-800"
                >
                    <ArrowLeft className="h-4 w-4 transition-transform group-hover:-translate-x-1" />
                ...
                <Link
                    href="/contact"
                    className="group inline-flex min-h-11 items-center justify-center gap-2 border border-slate-300 bg-white px-6 text-sm font-black text-slate-700 transition duration-200 hover:-translate-y-0.5 hover:border-[#C8102E] hover:text-[#C8102E]"
                >
                    Contact Secretariat
                    ...
                    (item, index) => {
                        ...
                        return (
                            <Link
                                ...
                                className={[
                                    "flex h-11 min-w-11 items-center justify-center px-3 text-sm font-black transition",
                                    isActive
...
function PaginationLink({
    ...
    return (
        <Link
            href={href}
            className="flex h-11 items-center justify-center gap-2 border border-slate-200 bg-white px-4 text-sm font-extrabold text-slate-700 transition hover:border-red-200 hover:bg-red-50 hover:text-[#C8102E]"
        >
            {!iconAfter ? icon : null}
            {label}
            {iconAfter ? icon : null}
...
function PaginationDisabled({
    ...
    return (
        <span
            aria-disabled="true"
            className="flex h-11 cursor-not-allowed items-center justify-center gap-2 border border-slate-100 bg-slate-100 px-4 text-sm font-extrabold text-slate-400"
        >
            {!iconAfter ? icon : null}
            {label}
            {iconAfter ? icon : null}
