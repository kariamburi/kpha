...
type Props = {
    ...
    welcomeSecondaryText?: string | null;
...
const fallbackSlides: PublicHeroSlide[] = [
    ...
    },
    {
        ...
        imageUrl: "/slider_reception.webp",
...
export default function PublicHeroLignt({
    ...
    const finalWelcomeTitle =
        welcomeTitle ||
        "Empowering Hospitality Professionals in Kenya";

    const finalWelcomeText =
        welcomeText ||
        "AHPK provides a digital platform for applications, renewals, certificate verification and member services.";

    const finalWelcomeSecondaryText =
        welcomeSecondaryText ||
        "We bring together hospitality professionals, educators, managers and industry leaders who are committed to quality, credibility and responsible professional practice.";

    const finalWelcomeImage =
        welcomeImageUrl ||
        "/welcome.webp";

    const finalPrimaryButtonLabel =
        primaryButtonLabel ||
        "Discover AHPK";

    const finalPrimaryButtonHref =
        primaryButtonHref ||
        "/about/who-we-are";

    const finalSecondaryButtonLabel =
        secondaryButtonLabel ||
        "Become a Member";

    const finalSecondaryButtonHref =
        secondaryButtonHref ||
        "/apply";
