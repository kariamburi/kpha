...
function getEffectiveStatus(
    ...
    /*
     * Suspension is an explicit administrative state,
    ...
    /*
     * Membership validity is determined by the
     * actual membership expiry date.
     */
...
export default async function MembersPage({
     ...
     * Important:
     *
     * We intentionally DO NOT filter Prisma directly
     * using member.status here.
     *
     * Effective status is calculated using expiryDate,
     * because a DB record could still say ACTIVE after
     * its calendar-year membership has expired.
     */
    const members =
    ...
    /*
     * Add effective status to each member.
     */
    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid gap-4 md:grid-cols-4">
                ...
                <StatCard
                    title="Suspended"
                    value={suspendedMembers.toString()}
                    tone="red"
                />
            </div>
