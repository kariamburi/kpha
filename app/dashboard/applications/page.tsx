    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid gap-4 md:grid-cols-4">
                <StatCard title="Total Applications" value={totalApplications.toString()} tone="blue" />
                <StatCard title="Pending" value={pendingApplications.toString()} tone="amber" />
                <StatCard title="Approved" value={approvedApplications.toString()} tone="green" />
                <StatCard title="Paid" value={paidApplications.toString()} tone="red" />
            </div>
