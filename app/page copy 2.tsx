...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-white text-slate-950">
      ...
      <section className="relative overflow-hidden bg-slate-50 py-0 sm:py-4">
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            ...
            <div className="overflow-hidden">
              <div className="grid">
                ...
                <div className="p-2 sm:p-3 lg:p-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-6 lg:grid-cols-2 xl:grid-cols-6">
                    {quickServices.map(
                      (service) => (
                        <HeroServiceCard
                          key={
          ...
          {/* Key areas */}
          <div className="mt-4 rounded-[28px] border border-slate-200 bg-white p-7 shadow-sm sm:p-9">
            <div className="mb-7">
              <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-[#C8102E]">
                What AHPK promotes
              </p>
...
function CenteredSectionHeader({ label, title, description }: { label: string; title: string; description: string }) {
  return (
    <div className="mx-auto max-w-3xl text-center">
      <SectionLabel>{label}</SectionLabel>
      <h2 className="mt-2 font-serif text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">{title}</h2>
      <p className="mt-2 text-sm font-medium leading-7 text-slate-600 sm:text-base">{description}</p>
    </div>
  );
}
